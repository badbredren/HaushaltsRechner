...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdminAccountToolBar.ascx.cs" Inherits="HaushaltsRechner.Views.Admin.AdminAccountToolBar" %>
...
<asp:ImageButton 
    ...
    Height="32px" 
    Width="32px" 
    OnClientClick="haushaltsRechner.client.dialogs.addEditAccount();return false;" 
